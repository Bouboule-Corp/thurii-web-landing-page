<script lang="ts">
    ...
    import Description from "../components/sections/Description.svelte";
    ...
    import Patchnotes from "$components/sections/Patchnotes.svelte";
</script>
...
<div>
    ...
    <div class="Landscape">
        <h1>
            This website was only visible on screen with a height of 500px or
            more.
        </h1>
    </div>
</div>
